...
namespace Gambit
{
  ...
  namespace Utils
  {
    ...
    class interp2d_simple_collection
    {
      public:
        ...
        // Constructor
        interp2d_simple_collection(const std::string, const std::string, const std::vector<std::string>);

        // Destructor
        ~interp2d_simple_collection();
    ...
    class interp5d_collection
    {
      public:
        ...
        // Constructor
        interp5d_collection(const std::string, const std::string, const std::vector<std::string>, bool);
    ...
    class interp4d_collection
    {
      public:
        ...
        // Constructor
        interp4d_collection(const std::string, const std::string, const std::vector<std::string>, bool);
