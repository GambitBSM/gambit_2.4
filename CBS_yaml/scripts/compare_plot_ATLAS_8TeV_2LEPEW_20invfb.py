...
print("The file path is hard-coded in so just enter the name. You are doing: " + name[:-4])
print("Process: " + str(process))
if process == 4:
  print("Pr4 SR: " + pr4_SR)
#print("For (1), the file path is hard-coded in so just the name is fine.")
#print("It'll ask you which process you're doing. If it's '4', (1) needs to be a file of either all ee, mumu, or emu cutflows.")
print("~~~~~~~~~~~~~~\n")


##process = int(name[-8]) if before else int(name[-1])
#process = int(input("Which process are you doing? "))
#if process == 4:
#  pr4_SR = raw_input("Are you doing ee, mumu, or emu? ")
...
if process == 4:
  ...
  factor1_cbs = xsect_1*20.3/242500
  factor2_cbs = xsect_2*20.3/242500
  factor3_cbs = xsect_3*20.3/242500
  if normalize:
