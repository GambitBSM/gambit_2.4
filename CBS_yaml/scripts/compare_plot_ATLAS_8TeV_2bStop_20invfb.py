...
print("\n~~~~~~~~~~~~~~")
print("The program identifies which process you're doing by the .txt file you pass in (pr1 or pr2)!")
...
data = np.genfromtxt("data_2bStop/" + name,dtype="str")
...
if name == '2013-05-pr1' or name == '2013-05-pr1-BEFORE':
#  sr_name = [r"(SRA: (1000, 1)) $E_T^{miss}>80$ GeV",
...
if name == '2013-05-pr1' or name == '2013-05-pr1-BEFORE':
  if normalize:
    ...
    plt.yticks([-0.8,-0.4,0,0.4,0.8,1.2,1.6],['-80%','-40%',0,'40%','80%','120%','160%'],rotation=90)
