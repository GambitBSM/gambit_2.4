...
print('~~~~~~~~~~~~~~~~~~~~~~~~')
print(name_a[-4:])
if ((name_a[-4:]!='mumu') or (name_b[-4:]!='mumu') or (name_c[-4:]!='mumu')) and (name_a[-6:]!='BEFORE'):
  raise Exception("Sorry, you need to input -mumu.txt files")
...
plt.step(x, atlas, where='mid', label=atlas_label, color='green')
