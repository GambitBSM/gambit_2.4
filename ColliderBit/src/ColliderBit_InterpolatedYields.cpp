  ...
  {  
    ...
    class Model_analysis_info
    {
      public:
        ...
        void add_interp4d(str name, str filename, std::vector<str> colnames, bool allow_missing_points)
        {
          ...
          interp4d[name] = std::unique_ptr<Utils::interp4d_collection>(new Utils::interp4d_collection(name, filename, colnames, allow_missing_points));
        }
        ...
        void add_interp5d(str name, str filename, std::vector<str> colnames, bool allow_missing_points)
        {
          ...
          interp5d[name] = std::unique_ptr<Utils::interp5d_collection>(new Utils::interp5d_collection(name, filename, colnames, allow_missing_points));
        }
    ...
    class Dijet_analysis_info
    {
      public:
        ...
        // Maps containing 1D and 2D interpolators
        std::map<str,std::unique_ptr<Utils::interp1d_collection>> interp1d;
        std::map<str,std::unique_ptr<Utils::interp2d_simple_collection>> interp2d_simple;
        ...
        void add_interp2d_simple(str name, str filename, std::vector<str> colnames)
        {
          ...
          interp2d_simple[name] = std::unique_ptr<Utils::interp2d_simple_collection>(new Utils::interp2d_simple_collection(name, filename, colnames));
        }
        ...
        Utils::interp2d_simple_collection& get_interp2d_simple(str name) const
        {
    ...
    void DMsimp_fill_analysis_info_map(std::map<str,str> Analysis_data_path, std::map<str,std::vector<str>> Interpolation_columns, int Ndim)
    {
      ...
      // New analysis: CMS_13TeV_MONOJET_137invfb_interpolated (taken from: https://www.hepdata.net/record/ins1894408)
    ...
    void DMsimpVectorMedScalarDM_monojet_results(AnalysisDataPointers& result)
    { 
      using namespace Pipes::DMsimpVectorMedScalarDM_monojet_results;
      ...
      for (const std::pair<str,const Model_analysis_info&>& aname_ainfo_pair : analysis_info_map)
      {
        ...
        get_all_DMsimpVectorMedScalarDM_signal_yields(sr_nums, ainfo, spec);
    ...
    void DMsimpVectorMedMajoranaDM_monojet_results(AnalysisDataPointers& result)
    { 
      using namespace Pipes::DMsimpVectorMedMajoranaDM_monojet_results;
      ...
      for (const std::pair<str,const Model_analysis_info&>& aname_ainfo_pair : analysis_info_map)
      {
        ...
        // Fill the signal yield vector with DMsimpVectorMedMajoranaDM signal predictions
        get_all_DMsimpVectorMedMajoranaDM_signal_yields(sr_nums, ainfo, spec);
    ...
    void DMsimpVectorMedDiracDM_monojet_results(AnalysisDataPointers& result)
    { 
      using namespace Pipes::DMsimpVectorMedDiracDM_monojet_results;
      ...
      for (const std::pair<str,const Model_analysis_info&>& aname_ainfo_pair : analysis_info_map)
      {
        ...
        // Fill the signal yield vector with DMsimpVectorMedDiracDM signal predictions
        get_all_DMsimpVectorMedDiracDM_signal_yields(sr_nums, ainfo, spec);
    ...
    /// Fill the input vector with the DMsimpVectorMedScalarDM signal prediction for SVS model
    ...
    /// Fill the input vector with the DMsimpVectorMedDiracDM signal prediction for SVF model
    ...
    /// Fill the input vector with the DMsimpVectorMedMajoranaDM signal prediction for SVMF model
    ...
    void DiJet_Likelihood_DMsimpVectorMedScalarDM(double& result)
    {
    
      using namespace Pipes::DiJet_Likelihood_DMsimpVectorMedScalarDM;
      ...
      result = Total_DiJet_search_like(mMed, gq, BR_q);
      
    }
    
    /// Di-jet likelihoods from interpolated xsecs
    /// This assumes the Narrow width approximation
    void DiJet_Likelihood_DMsimpVectorMedMajoranaDM(double& result)
    {
    
      using namespace Pipes::DiJet_Likelihood_DMsimpVectorMedMajoranaDM;
    ...
    /// Di-jet likelihoods from interpolated xsecs
    /// This assumes the Narrow width approximation
    void DiJet_Likelihood_DMsimpVectorMedDiracDM(double& result)
    {
    
      using namespace Pipes::DiJet_Likelihood_DMsimpVectorMedDiracDM;
