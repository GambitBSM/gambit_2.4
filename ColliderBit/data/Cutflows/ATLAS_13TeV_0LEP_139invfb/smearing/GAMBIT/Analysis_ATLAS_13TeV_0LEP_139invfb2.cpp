...
//        cout << "============================"<< endl;
//        cout << "MET: PT= "<< met << ",\t Phi=" << pmiss.phi() << endl;

//        auto jj = event->jets();
//        for(size_t i=0; i<jj.size(); i++){
//            cout << "Jet["<< i << "]: PT="<< jj[i]->pT() << ",\t Eta="<< jj[i]->abseta() << ",\t Phi="<< jj[i]->phi() <<endl;
//        }

//        auto ee = event->electrons();
//        sortByPt(ee);
//        for(size_t i=0; i<ee.size(); i++){
//            cout << "e["<< i << "]: PT="<< ee[i]->pT() << ",\t Eta="<< ee[i]->abseta() << ",\t Phi="<< ee[i]->phi() <<endl;
//        }
...
//        auto jj = event->jets();
//        for(size_t i=0; i<jj.size(); i++){
////            for(size_t j=i+1; j<jj.size(); j++){
////                if (jj[i]->pT()<jj[j]->pT())
//                    cout << ",\t Jet pt["<< i << "]: "<< jj[i]->pT();
////            }
//        }
//        cout << endl;
...
//    cout << "============================"<< endl;
//    cout << "Meff = "<< meff << ",\t leptonVeto=" << nElectrons + nMuons << endl;
    total++;
    if (signalJets50[0]->pT() < 200)
        cout << total << ",\t j1_pt=" << signalJets50[0]->pT() << ",\t j2_pt=" << signalJets50[1]->pT()  << endl;
