  ...
  namespace ColliderBit {
    ...
    public:
      ...
      Analysis_ATLAS_13TeV_0LEP_139invfb() {
        ...
        _cutflows.addCutflow("5j-1600", {"Pre-sel + MET + pT1 + meff",
                                         "Njet >= 2", "Cleaning",
                                         "Njet >=5",
                                         "Dphi(j123,MET)min", "Dphi(j4+,MET)min",
                                         "pT1", "|eta_x|", 
...
//            outputFile << dphimin_123 << "\t";
//            outputFile << signalJets50.size() << "\t";
//            outputFile << pmiss.phi() << "\t";
//         
//            for (size_t i = 0; i < signalJets50.size(); ++i)
//                outputFile << signalJets50[i]->phi() << "\t";
//            outputFile << endl;
        ...
        if (nJets50 >= 5) {
          if (_cutflows["5j-1600"].fillnext({
                true,
                dphimin_123 > 0.4, dphimin_more > 0.2,
                signalJets[0]->pT() > 600, etamax_5 < 2.8,
                met_sqrtHT > 16, meff > 1600}, w)) _counters.at("5j-1600").add_event(event);
        }
