...
echo "diff -rupN Rivet-3.0.1/src/Core/AnalysisHandler.cc ../installed/rivet/3.0.1/src/Core/AnalysisHandler.c" >> patch_rivet_3.0.1.dif
diff -rupN Rivet-3.0.1/src/Core/AnalysisHandler.cc ../installed/rivet/3.0.1/src/Core/AnalysisHandler.cc >> patch_rivet_3.0.1.dif
