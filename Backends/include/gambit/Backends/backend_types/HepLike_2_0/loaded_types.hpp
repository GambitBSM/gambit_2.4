...
#define HepLike_2_0_all_data \
  ...
  (( /*class*/(HL_nDimBifurGaussian),    /*constructors*/(("Factory_HL_nDimBifurGaussian_0__BOSS_7",())) (("Factory_HL_nDimBifurGaussian_1__BOSS_8",(std::basic_string<char>))) )) \
  (( /*class*/(HL_nDimGaussian),    /*constructors*/(("Factory_HL_nDimGaussian_0__BOSS_9",())) (("Factory_HL_nDimGaussian_1__BOSS_10",(std::basic_string<char>))) )) \
  (( /*class*/(HL_nDimLikelihood),    /*constructors*/(("Factory_HL_nDimLikelihood_0__BOSS_11",())) (("Factory_HL_nDimLikelihood_1__BOSS_12",(std::basic_string<char>))) )) \
