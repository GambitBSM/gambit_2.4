#ifndef __abstract_AnalysisHandler_Rivet_3_1_0_hh__
#define __abstract_AnalysisHandler_Rivet_3_1_0_hh__
   ...
   namespace Rivet
   {
      class Abstract_AnalysisHandler : public virtual AbstractBase
      {
         public:
            ...
            virtual void setCrossSection(::std::pair<double, double>, bool) =0;
   
            virtual void setCrossSection__BOSS(::std::pair<double, double>) =0;
...
#endif /* __abstract_AnalysisHandler_Rivet_3_1_0_hh__ */
