#ifndef __wrapper_AnalysisHandler_decl_Rivet_3_1_0_hh__
#define __wrapper_AnalysisHandler_decl_Rivet_3_1_0_hh__
   ...
   namespace Rivet
   {
      ...
      class AnalysisHandler : public WrapperBase
      {
         ...
         public:
            ...
            void setCrossSection(::std::pair<double, double> xsec, bool isUserSupplied);
...
#endif /* __wrapper_AnalysisHandler_decl_Rivet_3_1_0_hh__ */
