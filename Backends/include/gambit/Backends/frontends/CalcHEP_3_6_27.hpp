...
BE_FUNCTION(setModel, int, (char*, int), ("setModel", "_setModel"), "setModel")
BE_FUNCTION(calcMainFunc, int, (), ("calcMainFunc", "_calcMainFunc"), "calcMainFunc")
BE_FUNCTION(getMEcode, numout*, (int ,int, char*, char*, char*, char*), ("getMEcode", "_getMEcode") , "getMEcode")
BE_FUNCTION(passParameters, int, (numout*), ("passParameters", "_passParameters"), "passParameters")
BE_FUNCTION(assignVal, int, (char*, double), ("assignVal", "_assignVal"), "assignVal")
BE_FUNCTION(pMass, double, (char*), ("pMass", "_pMass"), "pMass")
BE_FUNCTION(pdg2mass, char*, (int), ("pdg2mass", "_pdg2mass"), "pdg2mass")
BE_FUNCTION(pdg2width, char*, (int), ("pdg2width", "_pdg2width"), "pdg2width")

BE_VARIABLE(varNames, char*, ("varNames", "_varNames"), "varNames")
BE_VARIABLE(VZdecay, int, ("VZdecay", "_VZdecay"), "VZdecay")
BE_VARIABLE(VWdecay, int, ("VWdecay", "_VWdecay"), "VWdecay")
