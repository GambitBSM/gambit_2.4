...
BE_CONV_FUNCTION(Contur_LogLike_from_stream, pybind11::object, (std::shared_ptr<std::ostringstream>, std::vector<std::string>&), "Contur_Measurements")
BE_CONV_FUNCTION(Contur_LogLike_from_file, pybind11::object, (str &, std::vector<std::string>&), "Contur_Measurements")
