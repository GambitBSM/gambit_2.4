...
///  *********************************************
///
///  MSSM63+light gravitino model declaration
...
#ifndef __MSSM63atMSUSY_lightgravitino_hpp__
#define __MSSM63atMSUSY_lightgravitino_hpp__
...
#define PARENT MSSM63atQ_lightgravitino
  ...
  /// Can translate this model into MSSM63atQ_lightgravitino (where Q will then be set to MSUSY)
  INTERPRET_AS_PARENT_FUNCTION(MSSM63atMSUSY_lightgravitino_to_MSSM63atQ_lightgravitino)
