...
#ifndef __MSSMatMGUT_mA_mG_hpp__
#define __MSSMatMGUT_mA_mG_hpp__

#include "gambit/Models/models/MSSMatMGUT_mG.hpp" // Must include models which are targets of translation functions
...
#define PARENT MSSM63atMGUT_mG
  ...
  /// Can translate this model into MSSM63atMGUT_mG
  INTERPRET_AS_PARENT_FUNCTION(MSSM63atMGUT_mA_mG_to_MSSM63atMGUT_mG)
...
#define PARENT MSSM63atMGUT_mA_mG
  ...
  INTERPRET_AS_PARENT_FUNCTION(MSSM30atMGUT_mA_mG_to_MSSM63atMGUT_mA_mG)
  INTERPRET_AS_X_FUNCTION(MSSM30atMGUT_mG, MSSM30atMGUT_mA_mG_to_MSSM30atMGUT_mG)
  INTERPRET_AS_X_DEPENDENCY(MSSM30atMGUT_mG, unimproved_MSSM_spectrum, Spectrum)
#undef PARENT
#undef MODEL
...
#define PARENT MSSM30atMGUT_mA_mG
  ...
  INTERPRET_AS_PARENT_FUNCTION(MSSM25atMGUT_mA_mG_to_MSSM30atMGUT_mA_mG)
#undef PARENT
#undef MODEL
...
#define PARENT MSSM25atMGUT_mA_mG
  ...
  INTERPRET_AS_PARENT_FUNCTION(MSSM20atMGUT_mA_mG_to_MSSM25atMGUT_mA_mG)
  INTERPRET_AS_X_FUNCTION(MSSM20atMGUT_mG, MSSM20atMGUT_mA_mG_to_MSSM20atMGUT_mG)
  INTERPRET_AS_X_DEPENDENCY(MSSM20atMGUT_mG, unimproved_MSSM_spectrum, Spectrum)
#undef PARENT
#undef MODEL
