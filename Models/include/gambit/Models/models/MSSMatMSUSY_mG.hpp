...
#ifndef __MSSMatMSUSY_mG_hpp__
#define __MSSMatMSUSY_mG_hpp__
...
#define PARENT MSSM63atQ_mG
  ...
  /// Can translate this model into MSSM63atQ_mG (where Q will then be set to MSUSY)
  INTERPRET_AS_PARENT_FUNCTION(MSSM63atMSUSY_mG_to_MSSM63atQ_mG)
...
#define PARENT MSSM63atMSUSY_mG
  ...
  INTERPRET_AS_PARENT_FUNCTION(MSSM30atMSUSY_mG_to_MSSM63atMSUSY_mG)
  INTERPRET_AS_X_FUNCTION(MSSM30atQ_mG, MSSM30atMSUSY_mG_to_MSSM30atQ_mG)
...
#define PARENT MSSM30atMSUSY_mG
  ...
  INTERPRET_AS_PARENT_FUNCTION(MSSM25atMSUSY_mG_to_MSSM30atMSUSY_mG)
#undef PARENT
#undef MODEL
...
#define PARENT MSSM25atMSUSY_mG
  ...
  INTERPRET_AS_PARENT_FUNCTION(MSSM20atMSUSY_mG_to_MSSM25atMSUSY_mG)
  INTERPRET_AS_X_FUNCTION(MSSM20atQ_mG, MSSM20atMSUSY_mG_to_MSSM20atQ_mG)
