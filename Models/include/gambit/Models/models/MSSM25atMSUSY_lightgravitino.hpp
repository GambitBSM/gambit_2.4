...
///  \file
///
///  MSSM25atMSUSY_lightgravitino model definition.
///
///  *********************************************
///
...
#ifndef __MSSM25atMSUSY_lightgravitino_hpp__
#define __MSSM25atMSUSY_lightgravitino_hpp__

// Parent model must be declared first! Include it here to ensure that this happens.
#include "gambit/Models/models/MSSM30atMSUSY_lightgravitino.hpp"

#define MODEL MSSM25atMSUSY_lightgravitino
#define PARENT MSSM30atMSUSY_lightgravitino
  START_MODEL
  ...
  INTERPRET_AS_PARENT_FUNCTION(MSSM25atMSUSY_lightgravitino_to_MSSM30atMSUSY_lightgravitino)
