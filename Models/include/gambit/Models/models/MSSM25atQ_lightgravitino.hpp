...
///  \file
///
///  MSSM25atQ_lightgravitino model definition.
///
///  *********************************************
///
...
#ifndef __MSSM25atQ_lightgravitino_hpp__
#define __MSSM25atQ_lightgravitino_hpp__

// Parent model must be declared first! Include it here to ensure that this happens.
#include "gambit/Models/models/MSSM30atQ_lightgravitino.hpp"

#define MODEL MSSM25atQ_lightgravitino
#define PARENT MSSM30atQ_lightgravitino
  START_MODEL
  ...
  INTERPRET_AS_PARENT_FUNCTION(MSSM25atQ_lightgravitino_to_MSSM30atQ_lightgravitino)
