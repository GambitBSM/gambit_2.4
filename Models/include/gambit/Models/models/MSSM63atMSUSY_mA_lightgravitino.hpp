...
#ifndef __MSSM63atMSUSY_mA_lightgravitino_hpp__
#define __MSSM63atMSUSY_mA_lightgravitino_hpp__

#include "gambit/Models/models/MSSM63atMSUSY_lightgravitino.hpp" // Must include models which are targets of translation functions
...
#define PARENT MSSM63atMSUSY_lightgravitino
  ...
  /// Can translate this model into MSSM63atMSUSY_lightgravitino
  INTERPRET_AS_PARENT_FUNCTION(MSSM63atMSUSY_mA_lightgravitino_to_MSSM63atMSUSY_lightgravitino)
