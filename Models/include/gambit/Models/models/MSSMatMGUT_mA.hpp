...
#ifndef __MSSMatMGUT_mA_hpp__
#define __MSSMatMGUT_mA_hpp__

#include "gambit/Models/models/MSSMatMGUT.hpp" // Must include models which are targets of translation functions
