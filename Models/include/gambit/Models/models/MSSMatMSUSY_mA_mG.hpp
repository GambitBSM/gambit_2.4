...
#ifndef __MSSMatMSUSY_mA_mG_hpp__
#define __MSSMatMSUSY_mA_mG_hpp__

#include "gambit/Models/models/MSSMatMSUSY_mG.hpp" // Must include models which are targets of translation functions
...
#define PARENT MSSM63atMSUSY_mG
  ...
  /// Can translate this model into MSSM63atMSUSY_mG
  INTERPRET_AS_PARENT_FUNCTION(MSSM63atMSUSY_mA_mG_to_MSSM63atMSUSY_mG)
  ...
  DEFINEPARS(TanBeta,mA,mu,M1,M2,M3,mG)
...
#define PARENT MSSM63atMSUSY_mA_mG
  ...
  INTERPRET_AS_PARENT_FUNCTION(MSSM30atMSUSY_mA_mG_to_MSSM63atMSUSY_mA_mG)
  INTERPRET_AS_X_FUNCTION(MSSM30atMSUSY_mG, MSSM30atMSUSY_mA_mG_to_MSSM30atMSUSY_mG)
  INTERPRET_AS_X_DEPENDENCY(MSSM30atMSUSY_mG, unimproved_MSSM_spectrum, Spectrum)
#undef PARENT
#undef MODEL
...
#define PARENT MSSM30atMSUSY_mA_mG
  ...
  INTERPRET_AS_PARENT_FUNCTION(MSSM25atMSUSY_mA_mG_to_MSSM30atMSUSY_mA_mG)
#undef PARENT
#undef MODEL
...
#define PARENT MSSM25atMSUSY_mA_mG
  ...
  INTERPRET_AS_PARENT_FUNCTION(MSSM20atMSUSY_mA_mG_to_MSSM25atMSUSY_mA_mG)
  INTERPRET_AS_X_FUNCTION(MSSM20atMSUSY_mG, MSSM20atMSUSY_mA_mG_to_MSSM20atMSUSY_mG)
  INTERPRET_AS_X_DEPENDENCY(MSSM20atMSUSY_mG, unimproved_MSSM_spectrum, Spectrum)
#undef PARENT
#undef MODEL
